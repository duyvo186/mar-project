            ...
            <div class="cart-info-group">
                ...
                <div class="cart-action-group">
                    <div class="product-action"><button class="action-minus" title="Quantity Minus"><i
                            ...
                            type="text" name="quantity" value="1"><button class="action-plus" title="Quantity Plus"><i
...
<aside class="nav-sidebar">
    ...
    <div class="nav-content">
        ...
        <div class="nav-select-group">
            <div class="nav-select"><i class="icofont-world"></i><select class="select" style="display: none;">
                    <option value="english" selected="">English</option>
                    <option value="bangali">Bangali</option>
                    <option value="arabic">Arabic</option>
                </select>
                <div class="nice-select select" tabindex="0"><span class="current">English</span>
                    <ul class="list">
                        <li data-value="english" class="option selected">English</li>
                        <li data-value="bangali" class="option">Bangali</li>
                        <li data-value="arabic" class="option">Arabic</li>
                    </ul>
                </div>
            </div>
            <div class="nav-select"><i class="icofont-money"></i><select class="select" style="display: none;">
                    <option value="english" selected="">Doller</option>
                    <option value="bangali">Pound</option>
                    <option value="arabic">Taka</option>
                </select>
                <div class="nice-select select" tabindex="0"><span class="current">Doller</span>
                    <ul class="list">
                        <li data-value="english" class="option selected">Doller</li>
                        <li data-value="bangali" class="option">Pound</li>
                        <li data-value="arabic" class="option">Taka</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="mobile-menu"><a href="index.html" title="Home Page"><i class="fas fa-home"></i><span>Home</span></a><button
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="view-gallery">
                            ...
                            <ul class="preview-slider slider-arrow slick-initialized slick-slider"><i
                                    class="icofont-arrow-right dandik slick-arrow" style="display: block;"></i>
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 0px;">
                                        <li class="slick-slide slick-current slick-active" data-slick-index="0"
                                            ...
                                            tabindex="0"><img src="images/product/01.jpg" alt="product"></li>
                                        <li class="slick-slide" data-slick-index="1" aria-hidden="true"
                                            style="width: 0px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0;"
                                            tabindex="-1"><img src="images/product/01.jpg" alt="product"></li>
                                ...
                                </div><i class="icofont-arrow-left bamdik slick-arrow" style="display: block;"></i>
                            </ul>
                            <ul class="thumb-slider slick-initialized slick-slider">
                                <div class="slick-list draggable" style="padding: 0px 50px;">
                                    <div class="slick-track"
                                        style="opacity: 1; width: 0px; transform: translate3d(99px, 0px, 0px);">
                                        <li class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned slick-active" data-slick-index="-1"
                                            aria-hidden="false" style="width: 0px;" tabindex="-1"><img
                                                src="images/product/01.jpg" alt="product"></li>
                                        <li class="slick-slide slick-current slick-active slick-center"
                                            data-slick-index="0" aria-hidden="false" style="width: 0px;" tabindex="0">
                                            <img src="images/product/01.jpg" alt="product"></li>
                                        <li class="slick-slide slick-active" data-slick-index="1" aria-hidden="false"
                                            style="width: 0px;" tabindex="0"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide" data-slick-index="2" aria-hidden="true"
                                            style="width: 0px;" tabindex="0"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        ...
                                        <li class="slick-slide" data-slick-index="6" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="7" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="8" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="9" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned slick-center" data-slick-index="10"
                                            aria-hidden="true" style="width: 0px;" tabindex="-1"><img
                                                src="images/product/01.jpg" alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="11" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="12" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                        <li class="slick-slide slick-cloned" data-slick-index="13" aria-hidden="true"
                                            style="width: 0px;" tabindex="-1"><img src="images/product/01.jpg"
                                                alt="product"></li>
                                    </div>
                                </div>
