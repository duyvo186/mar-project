          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <h2>Tastefully Yours</h2>
					...
					<div class="col-md-3 d-flex">
						...
						<div class="product ftco-animate">
							...
							<div class="text text-center">
                                ...
                                <h2>{{$item->ten}}</h2>
                                {{-- <h2>{{$item['soluong']}}</h2> --}}
                                <p class="mb-0"><span class="price price-sale"></span> <span class="price">{{number_format($item->gia)}}</span></p>
                            </div>
				...
				<div class="row justify-content-center">
					<div class="col-md-4">
						<a href="{{route('cart.index')}}" class="btn btn-primary d-block">View All Products <span class="fa fa-long-arrow-right"></span></a>
					</div>
				</div>
			</div>
		</section>
