...
class suppliercontroller extends Controller
{
    ...
    {
        $dssp = Supplier::where('trangthai', '!=', -1);
        // dd($dssp);
        //DB::table('sanpham')
        //->where('trangthai','!=','-1');
        ...
        $data =
            [
                'collection' => $dssp,
                'pagename' => 'Danh Sách Trạng Thái',
                'route' => $this->route
            ];
        return view('backend.trangthaisp.list', $data);
        //
    }
    ...
    public function create()
    {
        $data =
            [
                'pagename' => 'Thêm Trạnng Thái Sản Phẩm',
                'route' => $this->route,
                'action' => route($this->route . '.store'),
                'method' => 'POST'
            ];
        return view('backend.trangthaisp.form', $data);
        //
    }
